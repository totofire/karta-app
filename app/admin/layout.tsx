...
export default function AdminLayout({
  ...
  // --- OBTENCIÓN DE DATOS (Sin polling, solo fetch inicial y revalidación al foco) ---
  ...
  useEffect(() => {
    // Suscribimos a cualquier cambio en la tabla "Pedido"
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          // Cuando hay un INSERT, UPDATE o DELETE, mandamos a actualizar los contadores
          mutateCocina();
          mutateBarra();
        }
      )
          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                ...
                `}
              >
                {/* Contenedor del ícono con la Notificación */}
