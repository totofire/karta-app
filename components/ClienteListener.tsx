        ...
        <div className="flex-1 p-4">
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              <p className="text-sm font-bold text-gray-900">Hubo un inconveniente</p>
              <p className="mt-1 text-sm text-gray-500">Un pedido fue cancelado. Por favor consulta con el mozo.</p>
            </div>
            <div className="ml-4 flex-shrink-0 flex">
              <button className="bg-white rounded-md inline-flex text-gray-400 hover:text-gray-500 focus:outline-none" onClick={() => toast.dismiss(t.id)}>
        ...
        <div className="relative overflow-hidden rounded-t-2xl p-4 bg-gradient-to-r from-emerald-50 to-white">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-black text-gray-900 text-lg leading-tight">¡Pedido en camino!</h3>
